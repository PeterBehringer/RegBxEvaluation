...
ResDir='/Users/peterbehringer/MyStudies/Verification/CH-TG/Case'+case
try:
  os.system('mkdir '+ResDir)
except:
  pass
SegDir='/Users/peterbehringer/MyStudies/Beginner_Segmentations/Case'+case+'/'
...
cf.optionxform = str
cfFileName = '/Users/peterbehringer/MyStudies/Verification/CH-TG/Case'+case+'_VisAIRe.ini'
try:
