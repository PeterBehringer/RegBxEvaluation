...
RegDir='/Users/peterbehringer/MyStudies/Data/Case'+case+'/Slicer3registration'
...
IdentityTfm='/Users/peterbehringer/MyStudies/InitialTransforms/Identity.tfm'
movingMask = SegDir+'/CoverProstate-label.nrrd'
fixedMask = SegDir+'/'+lastId+'-label.nrrd'
Tfm1='/Users/peterbehringer/MyStudies/Data/Case'+case+'/Slicer3registration/'+lastId+'-IntraIntra-BSpline-Attempt2.tfm'

if not os.path.isfile(Tfm1):
  print 'entered Tfm2'
  Tfm1='/Users/peterbehringer/MyStudies/Data/Case'+case+'/Slicer3registration/'+lastId+'-IntraIntra-BSpline-Attempt1.tfm'

before = TempDir+'/Case'+case+'-'+lastId+'-before_Slicer3.nrrd'
after = TempDir+'/Case'+case+'-'+lastId+'-after_Slicer3.nrrd'
...
diceBefore = TempDir+'/Case'+case+'_dice_before_Slicer3.log'
diceAfter = TempDir+'/Case'+case+'_dice_after_Slicer3.log'
