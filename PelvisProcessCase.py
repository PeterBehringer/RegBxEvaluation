...
def BFRegister(fixed=None,moving=None,fixedMask=None,movingMask=None,rigidTfm=None,affineTfm=None,bsplineTfm=None,initializer=None,log=None,initTfm=None,initialTfm=None):
  ...
  if fixedMask and movingMask and bsplineTfm:
    ...
    print ('went into additional params')
  ...
  if fixedMask and movingMask and not bsplineTfm:
...
RegDir='/Users/peterbehringer/MyStudies/Data/Case'+case+'/Slicer4registration_pelvis'
TempDir='/Users/peterbehringer/MyStudies/TempDir_pelvis'
...
for nid in needleImageIds:
  ...
  fixedMask = IntraDir+'/'+nidStr+'-NONTG.nrrd'
  ...
  if not os.path.isfile(fixedMask):
    ...
    # need to register rigid again here, since there is no rigid output of the first BFRegister()
